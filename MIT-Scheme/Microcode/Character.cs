...
namespace Microcode
{
    static class Character
    {
        ...
        [SchemePrimitive ("CHAR->INTEGER", 1, false)]
        ...
        [SchemePrimitive ("INTEGER->CHAR", 1, false)]
