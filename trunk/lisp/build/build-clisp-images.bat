...
@IF NOT DEFINED DERIVED_IMAGE_PATH SET DERIVED_IMAGE_PATH=%CLISP_DIRECTORY%\development
@CALL :default DERIVED_IMAGE_NAME lispinit.mem
...
@START "Rebuild Lisp" /WAIT "%CLISP_BASE_IMAGE%" -M base\lispinit.mem -m 128MB -norc "%BUILD_SCRIPT%" "%DERIVED_IMAGE_PATH%\%DERIVED_IMAGE_NAME%"
@POPD
@ECHO Done.
