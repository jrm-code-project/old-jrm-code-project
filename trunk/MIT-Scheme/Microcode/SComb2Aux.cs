...
namespace Microcode
{
    ...
    class Combination2 : SCode, ISystemHunk3
    {
        ...
        public override bool Uses (object formal)
        {
    ...
    class Combination2AA1 : Combination2AA
    {
        ...
        {
            return
                (rand1 is LexicalVariable) ? Combination2AA1L.Make (rator, rand0, (LexicalVariable) rand1) :
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            return Interpreter.Call (out answer, ref expression, ref environment,
                environment.ArgumentValue (this.ratorOffset), environment.Argument1Value, ev1);
        }
    }

    class Combination2AA1L : Combination2AA1
    {
        public readonly object rand1Name;
        public readonly int rand1Depth;
        public readonly int rand1Offset;

        protected Combination2AA1L (Argument rator, Argument1 rand0, LexicalVariable rand1)
            : base (rator, rand0, rand1)
        {
        ...
        public static SCode Make (Argument rator, Argument1 rand0, LexicalVariable rand1)
        {
            return
                (rand1 is Argument) ? Unimplemented() :
                (rand1 is LexicalVariable1) ? Combination2AA1L1.Make (rator, rand0, (LexicalVariable1) rand1) :
                new Combination2AA1L (rator, rand0, rand1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("Combination2AA1L.EvalStep");
#endif
            object ev1;
    ...
    sealed class Combination2AA1L1 : Combination2AA1L
    {
        Combination2AA1L1 (Argument rator, Argument1 rand0, LexicalVariable1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (Argument rator, Argument1 rand0, LexicalVariable1 rand1)
        {
            return
               new Combination2AA1L1 (rator, rand0, rand1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("Combination2AA1L1.EvalStep");
#endif
            object ev1;
    ...
    sealed class Combination2AA1Q : Combination2AA1
    {
        public readonly object rand1Value;

        Combination2AA1Q (Argument rator, Argument1 rand0, Quotation rand1)
            : base (rator, rand0, rand1)
        {
            this.rand1Value = rand1.Quoted;
        }

        public static SCode Make (Argument rator, Argument1 rand0, Quotation rand1)
        {
            return
               new Combination2AA1Q (rator, rand0, rand1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("Combination2AA1Q.EvalStep");
#endif
            return Interpreter.Call (out answer, ref expression, ref environment,
                environment.ArgumentValue (this.ratorOffset), environment.Argument1Value, this.rand1Value);
        }
    }
    ...
    class Combination2AL : Combination2A
    {
        ...
        {
            return
                //(rand0 is Argument0) ? Combination2AA.Make (rator, (Argument) rand0, rand1) :
    ...
    class Combination2LA0 : Combination2LA
    {
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            rand1TypeHistogram.Note (this.rand1Type);
            noteCalls (this.rand1);
            SCode.location = "Combination2LA0.EvalStep";
#endif
            object ev1;
            Environment env = environment;
            Control unev = this.rand1;
            while (unev.EvalStep (out ev1, ref unev, ref env)) { };
#if DEBUG
            SCode.location = "Combination2LA0.EvalStep.1";
#endif
            if (ev1 == Interpreter.UnwindStack) {
                throw new NotImplementedException ();
                //((UnwinderState) env).AddFrame (new Combination2Frame0 (this, environment));
    ...
    class Combination2LSA : Combination2LSL
    {
        ...
        {
#if DEBUG
            Warm ("Combination2LSLA.EvalStep");
#endif
            object ev1 = environment.ArgumentValue (this.rand1Offset);
    ...
    sealed class Combination2LSA1 : Combination2LSA
    {
        ...
        {
#if DEBUG
            Warm ("Combination2LSLA1.EvalStep");
#endif
            object ev0;
            Environment env = environment;
            Control unev = this.rand0;
    ...
    sealed class Combination2SL1A0 : Combination2SL1A
    {
        ...
        {
#if DEBUG
            Warm ("Combination2SL1A0.EvalStep");
            noteCalls (this.rator);
            ratorTypeHistogram.Note (this.ratorType);
#endif
            object ev0;
    ...
    sealed class Combination2SQA0 : Combination2SQA
    {
        ...
        {
#if DEBUG
            Warm ("Combination2SQA0.EvalStep");
            noteCalls (this.rator);
            ratorTypeHistogram.Note (this.ratorType);
#endif
            object evop;
    ...
    class SimpleLet2 : Let2
    {
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            if (ev0 == Interpreter.UnwindStack) {
                ...
                ((UnwinderState) env).AddFrame (new SimpleLet2Frame1 (this, environment, ev1));
                environment = env;
                answer = Interpreter.UnwindStack;
                return false;
                throw new NotImplementedException (); 
    ...
    [Serializable]
    sealed class SimpleLet2Frame1 : SubproblemContinuation<SimpleLet2>, ISystemVector
    {
        readonly object ev0;

        public SimpleLet2Frame1 (SimpleLet2 combination2, Environment environment, object ev0)
            : base (combination2, environment)
        {
            this.ev0 = ev0;
        }
    ...
    class SimpleLet2L : SimpleLet2
    {
        ...
        {
            return
                (arg0 is Argument) ? SimpleLet2A.Make (rator, (Argument) arg0, arg1) :
                (arg0 is LexicalVariable1) ? SimpleLet2L1.Make (rator, (LexicalVariable1) arg0, arg1):
                (arg1 is LexicalVariable) ? SimpleLet2LL.Make (rator, arg0, (LexicalVariable) arg1) :
                (arg1 is Quotation) ? SimpleLet2LQ.Make (rator, arg0, (Quotation) arg1) :
    ...
    class SimpleLet2A : SimpleLet2L
    {

        protected SimpleLet2A (SimpleLambda rator, Argument rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument arg0, SCode arg1)
        {
            return
                (arg0 is Argument0) ? SimpleLet2A0.Make (rator, (Argument0) arg0, arg1) :
                (arg0 is Argument1) ? SimpleLet2A1.Make (rator, (Argument1) arg0, arg1) :
                (arg1 is LexicalVariable) ? Unimplemented() :
                (arg1 is Quotation) ? Unimplemented() :
                new SimpleLet2A (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0 : SimpleLet2A
    {

        protected SimpleLet2A0 (SimpleLambda rator, Argument0 rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, SCode arg1)
        {
            return
                (arg1 is LexicalVariable) ? SimpleLet2A0L.Make (rator, arg0, (LexicalVariable) arg1):
                (arg1 is Quotation) ? SimpleLet2A0Q.Make (rator, arg0, (Quotation) arg1):
                new SimpleLet2A0 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0L : SimpleLet2A0
    {

        protected SimpleLet2A0L (SimpleLambda rator, Argument0 rand0, LexicalVariable rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, LexicalVariable arg1)
        {
            return
                (arg1 is Argument) ? SimpleLet2A0A.Make (rator, arg0, (Argument) arg1) :
                (arg1 is LexicalVariable1) ? SimpleLet2A0L1.Make (rator, arg0, (LexicalVariable1) arg1) :
                new SimpleLet2A0L (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0A : SimpleLet2A0L
    {

        protected SimpleLet2A0A (SimpleLambda rator, Argument0 rand0, Argument rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, Argument arg1)
        {
            return
                (arg1 is Argument0) ? SimpleLet2A0A0.Make (rator, arg0, (Argument0) arg0) :
                (arg1 is Argument1) ? SimpleLet2A0A1.Make (rator, arg0, (Argument1) arg1) :
                new SimpleLet2A0A (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0A0 : SimpleLet2A0A
    {

        protected SimpleLet2A0A0 (SimpleLambda rator, Argument0 rand0, Argument0 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, Argument0 arg1)
        {
            return
                new SimpleLet2A0A0 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0A1 : SimpleLet2A0A
    {

        protected SimpleLet2A0A1 (SimpleLambda rator, Argument0 rand0, Argument1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, Argument1 arg1)
        {
            return
                new SimpleLet2A0A1 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0L1 : SimpleLet2A0L
    {

        protected SimpleLet2A0L1 (SimpleLambda rator, Argument0 rand0, LexicalVariable1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, LexicalVariable1 arg1)
        {
            return
                new SimpleLet2A0L1 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A0Q : SimpleLet2A0
    {

        protected SimpleLet2A0Q (SimpleLambda rator, Argument0 rand0, Quotation rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument0 arg0, Quotation arg1)
        {
            return
                new SimpleLet2A0Q (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A1 : SimpleLet2A
    {

        protected SimpleLet2A1 (SimpleLambda rator, Argument1 rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument1 arg0, SCode arg1)
        {
            return
                (arg1 is LexicalVariable) ? SimpleLet2A1L.Make (rator, arg0, (LexicalVariable) arg1) :
                (arg1 is Quotation) ? SimpleLet2A1Q.Make (rator, arg0, (Quotation) arg1) :
                new SimpleLet2A1 (rator, arg0, arg1);
        }
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            noteCalls (this.rator);
            noteCalls (this.rand1);
            SCode.location = "SimpleLet2A1.EvalStep";
#endif
            object ev1;
            Environment env = environment;
            Control unev = this.rand1;
    ...
    class SimpleLet2A1L : SimpleLet2A1
    {

        protected SimpleLet2A1L (SimpleLambda rator, Argument1 rand0, LexicalVariable rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument1 arg0, LexicalVariable arg1)
        {
            return
                (arg1 is Argument) ? SimpleLet2A1A.Make (rator, arg0, (Argument) arg1) :
                (arg1 is LexicalVariable1) ? Unimplemented () :
                new SimpleLet2A1L (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A1A : SimpleLet2A1L
    {

        protected SimpleLet2A1A (SimpleLambda rator, Argument1 rand0, Argument rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument1 arg0, Argument arg1)
        {
            return
                (arg1 is Argument0) ? Unimplemented () :
                (arg1 is Argument1) ? SimpleLet2A1A1.Make (rator, arg0, (Argument1) arg1) :
                new SimpleLet2A1A (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A1A1 : SimpleLet2A1A
    {

        protected SimpleLet2A1A1 (SimpleLambda rator, Argument1 rand0, Argument1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument1 arg0, Argument1 arg1)
        {
            return
                new SimpleLet2A1A1 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2A1Q : SimpleLet2A1
    {

        protected SimpleLet2A1Q (SimpleLambda rator, Argument1 rand0, Quotation rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, Argument1 arg0, Quotation arg1)
        {
            return
                new SimpleLet2A1Q (rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1 : SimpleLet2L
    {

        protected SimpleLet2L1 (SimpleLambda rator, LexicalVariable1 rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, SCode arg1)
        {
            return
                (arg1 is LexicalVariable) ? SimpleLet2L1L.Make (rator, arg0, (LexicalVariable) arg1) :
                (arg1 is Quotation) ? Unimplemented() :
                new SimpleLet2L1 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1L : SimpleLet2L1
    {
        public readonly object rand1Name;
        public readonly int rand1Depth;
        public readonly int rand1Offset;

        protected SimpleLet2L1L (SimpleLambda rator, LexicalVariable1 rand0, LexicalVariable rand1)
            : base (rator, rand0, rand1)
        {
            this.rand1Name = rand1.Name;
            this.rand1Depth = rand1.Depth;
        ...
        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, LexicalVariable arg1)
        {
            return
                (arg1 is Argument) ? SimpleLet2L1A.Make (rator, arg0, (Argument) arg1) :
                (arg1 is LexicalVariable1) ? SimpleLet2L1L1.Make (rator, arg0, (LexicalVariable1) arg1) :
                new SimpleLet2L1L (rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1A : SimpleLet2L1L
    {

        protected SimpleLet2L1A (SimpleLambda rator, LexicalVariable1 rand0, Argument rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, Argument arg1)
        {
            return
                (arg1 is Argument0) ? SimpleLet2L1A0.Make (rator, arg0, (Argument0) arg1) :
                (arg1 is Argument1) ? SimpleLet2L1A1.Make (rator, arg0, (Argument1) arg1) :
                new SimpleLet2L1A(rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1A0 : SimpleLet2L1A
    {

        protected SimpleLet2L1A0 (SimpleLambda rator, LexicalVariable1 rand0, Argument0 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, Argument0 arg1)
        {
            return
                new SimpleLet2L1A0 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1A1 : SimpleLet2L1A
    {

        protected SimpleLet2L1A1 (SimpleLambda rator, LexicalVariable1 rand0, Argument1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, Argument1 arg1)
        {
            return
                new SimpleLet2L1A1 (rator, arg0, arg1);
        }
    ...
    class SimpleLet2L1L1 : SimpleLet2L1L
    {
        protected SimpleLet2L1L1 (SimpleLambda rator, LexicalVariable1 rand0, LexicalVariable1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (SimpleLambda rator, LexicalVariable1 arg0, LexicalVariable1 arg1)
        {
            if (arg0.Offset == arg1.Offset) Debugger.Break ();
            return
                new SimpleLet2L1L1 (rator, arg0, arg1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("SimpleLet2L1L1.EvalStep");
            noteCalls (this.rator);
#endif
            object ev1;
            if (environment.FastLexicalRef1 (out ev1, this.rand1Name, this.rand1Offset))
    ...
    class Combination2AA0 : Combination2AA
    {
        ...
        {
            return
                (rand1 is LexicalVariable) ? Combination2AA0L.Make (rator, rand0, (LexicalVariable) rand1):
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            return Interpreter.Call (out answer, ref expression, ref environment, 
                environment.ArgumentValue (this.ratorOffset), environment.Argument0Value, ev1);
        }
    }

    class Combination2AA0L : Combination2AA0
    {
#if DEBUG
        static Histogram<Type> rand0TypeHistogram = new Histogram<Type> ();
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        protected Combination2AA0L (Argument rator, Argument0 rand0, LexicalVariable rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (Argument rator, Argument0 rand0, LexicalVariable rand1)
        {
            return
                (rand1 is Argument) ? Combination2AA0A.Make (rator, rand0, (Argument) rand1) :
                (rand1 is LexicalVariable1) ? Unimplemented() :
                new Combination2AA0L (rator, rand0, rand1);
        }
    ...
    sealed class Combination2AA0Q : Combination2AA0
    {
#if DEBUG
        static Histogram<Type> rand0TypeHistogram = new Histogram<Type> ();
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        Combination2AA0Q (Argument rator, Argument0 rand0, Quotation rand1)
            : base (rator, rand0, rand1)
        {
        }
    ...
    class Combination2AA0A : Combination2AA0
    {
        ...
        public static SCode Make (Argument rator, Argument0 rand0, Argument rand1)
        {
            return
                (rand1 is Argument0) ? Unimplemented() :
                (rand1 is Argument1) ? Combination2AA0A1.Make (rator, rand0, (Argument1) rand1) :
    ...
    sealed class Combination2AA0A1 : Combination2AA0A
    {
#if DEBUG
        static Histogram<Type> rand0TypeHistogram = new Histogram<Type> ();
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        Combination2AA0A1 (Argument rator, Argument0 rand0, Argument1 rand1)
            : base (rator, rand0, rand1)
        {
        }
    ...
    sealed class Combination2AA1A1 : Combination2AA1A
    {
#if DEBUG
        static Histogram<Type> rand0TypeHistogram = new Histogram<Type> ();
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        Combination2AA1A1 (Argument rator, Argument1 rand0, Argument1 rand1)
            : base (rator, rand0, rand1)
        {
        }
    ...
    class Combination2A1Q : Combination2A1
    {
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            return Interpreter.Call (out answer, ref expression, ref environment, 
                environment.Argument1Value, this.rand0Value, ev1);
        }
    }
    ...
    class Combination2L1CarA0 : Combination2L1
    {
#if DEBUG
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        protected Combination2L1CarA0 (LexicalVariable1 rator, PrimitiveCarA0 rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (LexicalVariable1 rator, PrimitiveCarA0 rand0, SCode rand1)
        {
            return
                (rand1 is PrimitiveCarA1) ? Combination2L1CarA0CarA1.Make (rator, rand0, (PrimitiveCarA1) rand1) :
                 new Combination2L1CarA0 (rator, rand0, rand1);
        }
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            noteCalls (this.rand1);
            rand1TypeHistogram.Note (this.rand1Type);
            SCode.location = "Combination2LCarA0.EvalStep";
#endif
    ...
    sealed class Combination2L1CarA0CarA1 : Combination2L1CarA0
    {
        Combination2L1CarA0CarA1 (LexicalVariable1 rator, PrimitiveCarA0 rand0, PrimitiveCarA1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (LexicalVariable1 rator, PrimitiveCarA0 rand0, PrimitiveCarA1 rand1)
        {
            return
                new Combination2L1CarA0CarA1 (rator, rand0, rand1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("Combination2LCarA0CarA1.EvalStep");
#endif
            object evop;
            if (environment.FastLexicalRef1 (out evop, this.ratorName, this.ratorOffset))
                throw new NotImplementedException ();
            ...
            return Interpreter.Call (out answer, ref expression, ref environment, evop, 
                ((Cons) environment.Argument0Value).Car, 
                ((Cons) environment.Argument1Value).Car);
        }
    }

    class Combination2L1CdrA0 : Combination2L1
    {
#if DEBUG
        static Histogram<Type> rand1TypeHistogram = new Histogram<Type> ();
#endif
        protected Combination2L1CdrA0 (LexicalVariable1 rator, PrimitiveCdrA0 rand0, SCode rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (LexicalVariable1 rator, PrimitiveCdrA0 rand0, SCode rand1)
        {
            return
                (rand1 is PrimitiveCdrA1) ? Combination2L1CdrA0CdrA1.Make (rator, rand0, (PrimitiveCdrA1) rand1) :
                 new Combination2L1CdrA0 (rator, rand0, rand1);
        }
        ...
        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
            ...
            noteCalls (this.rand1);
            rand1TypeHistogram.Note (this.rand1Type);
            SCode.location = "Combination2L1CdrA0.EvalStep";
#endif
    ...
    sealed class Combination2L1CdrA0CdrA1 : Combination2L1CdrA0
    {
        Combination2L1CdrA0CdrA1 (LexicalVariable1 rator, PrimitiveCdrA0 rand0, PrimitiveCdrA1 rand1)
            : base (rator, rand0, rand1)
        {
        }

        public static SCode Make (LexicalVariable1 rator, PrimitiveCdrA0 rand0, PrimitiveCdrA1 rand1)
        {
            return
                new Combination2L1CdrA0CdrA1 (rator, rand0, rand1);
        }

        public override bool EvalStep (out object answer, ref Control expression, ref Environment environment)
        {
#if DEBUG
            Warm ("Combination2L1CdrA0CdrA1.EvalStep");
#endif
            object evop;
            if (environment.FastLexicalRef1 (out evop, this.ratorName, this.ratorOffset))
                throw new NotImplementedException ();
            ...
            return Interpreter.Call (out answer, ref expression, ref environment, evop, 
                ((Cons) environment.Argument0Value).Cdr, 
                ((Cons) environment.Argument1Value).Cdr);
        }
    }
...
//        {
//            return
//                new Combination2L1SL1 (rator, rand0, rand1);
//        }
...
//            object ev1;
//            if (environment.FastLexicalRef (out ev1, this.randName, this.randDepth, this.randOffset))
//                throw new NotImplementedException ();
...
//            // expression = (SCode) evop;
//            return Interpreter.Call (out answer, ref expression, ref environment, evop, environment.ArgumentValue(randOffset), ev1);
//        }
//    }
